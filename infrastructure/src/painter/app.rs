...
use super::message::{Message, PredictionResult, TrainingResult};
            ...
            Message::TrainModel => {
                if !self.is_training {
                    ...
                    return Task::perform(
                        ...
                        |(_model, result)| Message::TrainingComplete(result),
                    );
                }
            }
            Message::TrainingComplete(result) => {
                self.is_training = false;
                self.training_result = Some(result.clone());
